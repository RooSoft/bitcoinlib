defmodule BitcoinLib.Test.Integration.Bip174.InvalidPsbtsTest do
  ...
  test "Case: PSBT missing outputs" do
    ...
    assert "some outputs are missing" == message
  end
  ...
  test "Case: PSBT with invalid pubkey in input BIP 32 derivation paths typed key" do
    base_64 =
  ...
  test "Case: PSBT with invalid non-witness utxo typed key" do
    base_64 =
    ...
    assert message =~ "invalid non-witness utxo key"
  end

  test "Case: PSBT with invalid final scriptsig typed key" do
    base_64 =
      ""

    {:error, message} = base_64 |> Psbt.parse()

    assert message =~ "invalid final script sig typed key"
  end

  test "Case: PSBT with invalid final script witness typed key" do
    base_64 =
    ...
    assert message =~ "invalid final script witness typed key"
  end

  test "Case: PSBT with invalid pubkey in output BIP 32 derivation paths typed key" do
    base_64 =
  ...
  test "Case: PSBT with invalid input sighash type typed key" do
    base_64 =
  ...
  test "Case: PSBT with invalid output witnessScript typed key" do
    base_64 =
  ...
  test "Case: PSBT with unsigned tx serialized with witness serialization format" do
    base_64 =
