defmodule BitcoinLib.Key.PublicKeyTest do
  use ExUnit.Case, async: true

  doctest BitcoinLib.Key.PublicKey
  ...
  test "serialize a master public key" do
    ...
    {:ok, serialized} = PublicKey.serialize(public_key)
  ...
  test "serialize and deserialize an xpub key and make sure they're the same" do
    ...
    {:ok, serialized} = PublicKey.serialize(original_public_key, :xpub)
  ...
  test "derive the first child" do
    ...
    result = PublicKey.derive_child(public_key, index)
  ...
  test "derive the first child, without error checking" do
    ...
    child = PublicKey.derive_child!(public_key, index)
  ...
  test "derive a public key from a derivation path" do
    ...
    derived_key = PublicKey.from_derivation_path(public_key, derivation_path)
  ...
  test "create a testnet P2PKH address" do
    ...
    address =
      public_key
      |> PublicKey.to_address(:p2pkh, :testnet)
  ...
  test "create a testnet P2SH address" do
    ...
    address =
      public_key
      |> PublicKey.to_address(:p2sh, :testnet)
