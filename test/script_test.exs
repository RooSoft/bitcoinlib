defmodule BitcoinLib.ScriptTest do
  ...
  test "parse a standard transaction to bitcoin address (pay-to-pubkey-hash)" do
    ...
    pub_key_hash = "12AB8DC588CA9D5787DDE7EB29569DA63C3A238C"

    script =
      <<@dup::8, @hash_160::8, pub_key_hash_size::8, pub_key_hash::binary-20, @equal_verify::8,
        @check_sig::8>>
    ...
    {:error, message} = Script.execute(script, [sig, pub_key]) |> IO.inspect
